...
<section id="globalPage">
    ...
    <div class="main">
        <div class="content index active">
            ...
            <h1>핫딜 판매 내역 💸️</h1>
            <!--핫딜 판매 내역이 없는 경우-->
            <c:if test="${empty PaymentList}">  <!--이거 수정해야함!-->
                <div class="msg__wrap">
                    <i class="fa-solid fa-circle-info"></i>
...
<%--            &lt;%&ndash;&ndash;%&gt;--%>
<%--            &lt;%&ndash; 사업자가 진행한 핫딜의 결제정보(payment)에 대한 data&ndash;%&gt;--%>
<%--            <section>--%>
                ...
                <div class="userList">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="${myReqHotdealDto.evaluate_code == 0 ?  "req" : "deny"}">${myReqHotdealDto.evaluate_code == 0 ?  "심사진행중" : "심사반려"}</td>
                                <%--   이거 삼항 연산자 2번 필요한데, 난 저번에 jstl에서 삼항연산자 2번쓰는거 실패했어요.                                         --%>
                                <%--     evaluate code 가 -1,0,1 일때 각각~   --%>

                        </tr>
                        </tbody>
                    </table>
                </div>
                <c:if test="${myReqHotdealDto.evaluate_code eq -1}">
...
<%--                    </li>--%>
<%--                </c:forEach>--%>
<%--                &lt;%&ndash;                <c:forEach var="hotdealDto" items="${hotdealDto}">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_NUM} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.restr_NUM} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.restr_category_loc} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.restr_menu_NUM} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.restr_menu_food} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.restr_menu_price} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_price} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_discountRate} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_desc} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_useDate} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_eventDuration} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_regdate} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_update} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_salesVolume} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.hotdeal_MaxSalesVolume} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    ${hotdealDto.bizAccount_email} </br>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    &lt;%&ndash;                      <tr>&ndash;%&gt;&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    &lt;%&ndash;                        <td class="bno">${hotdealDto.hotdeal_salesVolume}</td>&ndash;%&gt;&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    &lt;%&ndash;                        <td class="writer">${hotdealDto.hotdeal_MaxSalesVolume}</td>&ndash;%&gt;&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    &lt;%&ndash;                      </tr>&ndash;%&gt;&ndash;%&gt;--%>
...
<%--                    <table>--%>
<%--                        <tbody>--%>
<%--                        &lt;%&ndash;            salesVolume&ndash;%&gt;--%>
<%--                        &lt;%&ndash;            maxSalesVolume&ndash;%&gt;--%>
<%--                        &lt;%&ndash;            <c:forEach var="paymentDto" items="${paymentDto}">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;              <tr>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                <td class="bno">${paymentDto.}</td>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                <td class="writer">${paymentDto.}</td>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;              </tr>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;            </c:forEach>&ndash;%&gt;--%>
<%--                        </tbody>--%>
<%--                    </table>--%>
...
<%--&lt;%&ndash;&ndash;%&gt;--%>
<%--&lt;%&ndash;// 사업자가 요청/문의한 QNA 에 대한 data&ndash;%&gt;--%>
<%--<section>--%>
