...
<h2> "성공적으로 등록되었습니다. 핫딜 이벤트 심사에는 최대 일주일 가량 소요될 수 있고 , 빠른 시일 내에 고객님의 이메일( ${hotdealDto.bizAccount_email} )로 답변 드리겠습니다.  심사 기간 중 추가적인 요청/문의 사항이 있다면 Mypage 하단의 QNA 게시판을 이용해 주십시오. Nectar를 이용해 주셔서 감사합니다."
</h2>